<template>
	<view>
		...
		<u-line color="#ccc"></u-line>
		<view class="ipt"><view class="txt">身份证</view><u-input v-model="cardId" input-align="right"  placeholder="身份证">{{cardId}}</u-input></view>
		<u-line color="#ccc"></u-line>
		<view class="ipt"><view class="txt">出生年月</view><u-input v-model="birthday" input-align="right"  placeholder="出生年月 格式xx-xx-xx" >{{birthday}}</u-input></view>
		<u-line color="#ccc"></u-line>
	...
	export default {
		...
		methods:{
			...
			async goSure(){
				...
				let getAddUser = await this.$u.api.getAddUser(obj)
				uni.navigateTo({
					url:"../hosptalMake/hosptalMake",
					success(){
